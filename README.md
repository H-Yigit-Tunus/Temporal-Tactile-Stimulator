...
To run TTS, you need to download the Arduino IDE software (arduino.cc/en/software), which is completely free. After completing the installation, plug TTS into any USB port on your computer, run the software, and follow the steps below:
...
3. Paste the code to the software and click upload button (highlighted with red rectangle)
```cpp
